...
import pic01 from '../assets/images/grawler_station.png'
import pic02 from '../assets/images/seriema.png'
import pic03 from '../assets/images/caliandra.png'
import pic04 from '../assets/images/tamandua.png'
import pic05 from '../assets/images/loboguara.png'
import pic06 from '../assets/images/buraqueira.png'
                ...
                <div id="main">
                    <section id="one" className="tiles">
                        ...
                        <article style={{backgroundImage: `url(${pic06})`}}>
                            <header className="major">
                                <h3>Buraqueira</h3>
                                <p>Maturada com café 100% arábica Antonello Monardo, essa double brown ale tem xxxx</p>
                            </header>
                            <Link to="/landing" className="link primary"></Link>
                        </article>
                    </section>
